...
async def llm_peer_comparison(project_name: str, archetype: str, scan: dict[str, Any], score: dict[str, Any], db=None, user_id: Optional[str] = None) -> dict[str, Any]:
    """Ask the user's IDE LLM to compare this architecture to peer apps."""
    if db is None:
        return {"peers": [], "summary": ""}

    # Curated archetype → industry peer hints.
